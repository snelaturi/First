...
public class ProducerConsumerSolutionUsingLock {
	...
	public static void main(String[] args) {
		...
		Producer5 p = new Producer5(sharedObject);
		Consumer5 c = new Consumer5(sharedObject);
...
class Producer5 extends Thread {
	...
	public Producer5(ProducerConsumerImpl sharedObject) {
		super("PRODUCER");
...
class Consumer5 extends Thread {
	...
	public Consumer5(ProducerConsumerImpl sharedObject) {
		super("CONSUMER");
		this.pc = sharedObject;
	}

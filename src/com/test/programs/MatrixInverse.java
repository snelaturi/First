...
public class MatrixInverse {
	 ...
	 * 
	 * System.out.println("Original matrix display " + original[1][1]); for(int
	 * i=0; i<original.length;i++) { for(int j=0;j<original.length;j++){
	 * System.out.print(" "+ original[i][j]); } System.out.println(""); }
	 * 
	 * int[][] reverse = inverse(original);
	 * 
	 * }
	 */
